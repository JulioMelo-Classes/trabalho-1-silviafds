...
void apresentar2(std::vector<int> &num_sorteados, std::vector<int> &num_igual, int valor_do_premio, int valor_total, int cont, int num_jogadas, int valor_da_aposta);
